  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <motion.h1
          className="text-5xl md:text-7xl text-foreground font-semibold"
        ...
        >
          I&rsquo;m{' '}
          <motion.span
            className="text-chart-1 font-semibold inline-block min-w-[300px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
          >
      ...
      <button
        onClick={onContinue}
        className="absolute bottom-30 px-6 py-2 text-lg border border-foreground rounded hover:bg-foreground hover:text-background transition"
      >
        Go to Menu ↓
      </button>
    </motion.section>
